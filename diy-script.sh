...
svn export https://github.com/kiddin9/openwrt-packages/tree/master/daed package/daed
svn export https://github.com/kiddin9/openwrt-packages/tree/master/luci-app-daed package/luci-app-daed
